Attribute VB_Name = "XLSpeedUpTest"
...
Private Sub TurnOn_MultipleTimesWithChangingOptionalSettings_ReturnsVarious()
    ...
    Next
    With Application
        Assert.IsFalse .EnableEvents, "2 EnvableEvents"
    ...
    Next
    With Application
        Assert.IsFalse .EnableEvents, "1off EnvableEvents"
    ...
    Next
    With Application
        Assert.IsFalse .EnableEvents, "0 EnvableEvents"
